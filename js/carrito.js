    ...
    
    {
        ...
        subcategory: "calza",
        brand: "Scott",
        name: "Calza Corta Hellium",
        price: 5032,
        image: 'images/indumentaria/calzas/calza-scott-300x300.jpg',
        imagelg: 'images/indumentaria/calzas/calza-scott.jpg',
        description: 'Calza Corta Scott Helium Ciclismo',
        list: [
            'Diseño específico para ciclismo',
            'Cortes anatómicos',
            'Badana hipoalergénica Scott Performanceli',
            'Tejido respirable y de Lycra con protección UV.',
            'Transfer de logo reflectivo.'
        ],
        stock: 4,
    ...
    },
    {
        ...
        name: "Cadence",
        price: 25781,
        image: 'images/indumentaria/cascos/scott-cadence-300x300.jpg',
        imagelg: 'images/indumentaria/cascos/scott-cadence.jpg',
        ...
        list: [
            'Uso: Carretera',
            'Construcción: Tecnología en molde,Microcapa externa en PC',
            'Ajuste Sistema: HALO',
            'Diseño aerodinámico optimizado',
            'MIPS con tecnología SCOTT AIR',
            'Ventilación optimizada',
            'Acolchado antibacteriano X-Static',
            'Tapones para invierno',
            'Peso Aproximado: 270g'
        ],
        stock: 3,
        section: 'indumentaria', 
    },
    {
        ...
        price: 24976,
        image: 'images/indumentaria/cascos/scott-centric-300x300.jpg',
        imagelg: 'images/indumentaria/cascos/scott-centric.jpg',
        ...
        list: [
            'Diseño aerodinámico optimizado',
            'Sistema de protección encefálica MIPS® con tecnología SCOTT AIR',
    ...
    },
    {
        ...
        name: "Fuga Plus Red",
        price: 22175,
        image: 'images/indumentaria/cascos/scott-fuga-300x300.jpg',
        imagelg: 'images/indumentaria/cascos/scott-fuga.jpg',
        ...
        list: [
            'MTB',
            'Construccion Tecnología en molde',
            'Microcarcasa en policarbonato',
            'Ajuste sistema Halo',
            'Sistema de protección encefálica',
            'Ventilación optimizada',
            'Acolchado antibacteriano',
            'Adhesivo reflectantes de seguridad',
            'Visera desmontable',
    ...
    },
    {
        ...
        name: "Vanish",
        price: 20589,
        image: 'images/indumentaria/cascos/scott-vanish-300x300.jpg',
        imagelg: 'images/indumentaria/cascos/scott-vanish.jpg',
        description: '',
        list: [
    ...
    },
    {
        ...
        subcategory: "casco",
        brand: "Scott",
        name: "Fuga Plus Black",
        price: 16990,
        image: 'images/indumentaria/cascos/scott-fuga-black-300x300.jpg',
        imagelg: 'images/indumentaria/cascos/scott-fuga-black.jpg',
        description: 'El Fuga PLUS es el casco perfecto para corredores de XC y de carretera que buscan un casco de altas prestaciones. Incluye el sistema de protección encefálica MIPS, el ajuste HALO 3D, la mejor ventilación de su categoría y una visera desmontable para alternar entre carretera y MTB.',
        list: [
            'MTB',
            'Construccion Tecnología en molde',
    ...
    },
    {
        ...
        name: "Arx",
        price: 13970,
        image: 'images/indumentaria/cascos/scott-arx-300x300.jpg',
        imagelg: 'images/indumentaria/cascos/scott-arx.jpg',
        description: '',
        list: [
            'Material de la carcasa: In-Mold policarbonato',
            'Espuma de impacto: EPS',
            'Ajuste de ajuste: MRAS2',
            'Peso: 240 g'
        ],
        stock: 2,
        section: 'indumentaria', 
    },
    {
        ...
        name: "Supra",
        price: 9959,
        image: 'images/indumentaria/cascos/scott-supra-300x300.jpg',
        imagelg: 'images/indumentaria/cascos/scott-supra.jpg',
        description: '',
        list: [
    ...
    },
    {
        ...
        name: "Team Mitas",
        price: 6580,
        image: 'images/indumentaria/jerseys/jerser-mitas-300x300.jpg',
        imagelg: 'images/indumentaria/jerseys/jersey-mitas.jpg',
        description: '',
        list: [
            'Jersey de calidad internacional',
            'Costuras elásticas de gran resistencia',
            'Diseño FIT'
        ],
        stock: 5,
        section: 'indumentaria', 
    },
    {
        ...
        name: "Premium Jersey",
        price: 4180,
        image: 'images/indumentaria/jerseys/jerser-scott-premium-300x300.jpg',
        imagelg: 'images/indumentaria/jerseys/jerser-scott-premium.jpg',
        description: '',
        list: [
            'Confeccionada con materiales de altísima calidad',
            'El jersey SCOTT PREMIUM posee bolsillos traseros y cierre escondido.',
            'Disponible en talles S – M – L -XL y XXL'
        ],
        stock: 10,
        section: 'indumentaria', 
    },
    {
        ...
        name: "Jawbreaker",
        price: 17900,
        image: 'images/indumentaria/lentes/oakley-jawbreaker-carbon-300x300.jpg',
        imagelg: 'images/indumentaria/lentes/oakley-jawbreaker-carbon.jpg',
        description: 'Jawbreaker es lo último en diseño deportivo, es la respuesta a las demandas de atletas de todo el mundo con una herencia de 40 años de excelencia. La innovación de Oakley ha llegado al máximo de rendimiento al ofrecer desde aberturas de regulación para el flujo de aire de refrigeración a componentes de Unobtainium para una fijación segura y cómoda, y con el cambio de lentes sin problemas de la tecnología Switchlock para optimizar la visión para cualquier entorno.',
        list: [
            'Marca: Oakley',
            'Género: Unisex',
            'Calibre: 31mm',
            'Color del Armazón: Negro Brillante',
            'Color del Lente: Rosa Prizm Trail',
            'Estilo del Marco: Marco Completo',
            'Material del Lente: Policarbonato',
            'Indice de Proteccion: 2N',
            'Dimensiones: 31mm Ancho/ 131mm Puente/ 121mm Patilla',
            '100% Protección UV',
            'Condiciones de luz: Luz Media',
            'Transmision de Luz: 35%',
            'Contraste: aumentado',
            'Color de la lente base: Rosa',
        ],
        stock: 3,
        section: 'indumentaria', 
    },
    {
        ...
        name: "Dinamic",
        price: 11792,
        image: 'images/indumentaria/lentes/audax-fotocromatico-300x300.jpg',
        imagelg: 'images/indumentaria/lentes/audax-fotocromatico.jpg',
        description: '',
        list: [
            'Lentes de alto rendimiento Audax',
            'Cristales fotocromaticos que se adaptan a los cambios de luz',
            'Incluye estuche rígido y funda'
        ],
        stock: 2,
        section: 'indumentaria', 
    },
    {
        ...
        name: "Forerruner 245",
        price: 44899,
        image: 'images/indumentaria/relojes/garmin-245-300x300.jpg',
        imagelg: 'images/indumentaria/relojes/garmin-245.jpg',
        description: '',
        list: [
            'Tú te encargas de correr. Y el Forerunner 245 de pensar. Este reloj inteligente con GPS no solo te indica por dónde has estado corriendo. Realiza un seguimiento de tus estadísticas, procesa los datos y averigua todo sobre tu rendimiento, técnica, historial de entrenamiento e, incluso, tus objetivos personales. Solo te tendrás que preocupar de ir colocando un pie delante de otro.',
            'Análisis de rendimiento avanzado',
            '¿Cuánto entrenamiento es apropiado para ti? Forerunner 245 ofrece un entrenamiento individualizado y consejos para la recuperación con los que podrás tomar mejores decisiones en cuanto al entrenamiento y te ayudará a prepararte para la próxima carrera. Controla el VO2 máximo y entiende cómo afectan al rendimiento el calor y la altitud. Cuanto mayor sea este número, más probabilidades tendrás de alcanzar un buen rendimiento, que es exactamente lo que indica la condición de rendimiento . El estado de entrenamiento evalúa automáticamente tu historial de ejercicio reciente y tus indicadores de rendimiento, para que sepas si tu entrenamiento es productivo, si has llegado a tu meta de forma o si estás realizando un sobreesfuerzo. Comprueba cómo influyen tus entrenamientos en el desarrollo de la resistencia, la velocidad y la potencia con información de Training Effect aeróbico y anaeróbico . El tiempo de recuperación te ayuda a maximizar los beneficios de tu esfuerzo prediciendo cuándo te encontrarás en condiciones de enfrentarte al siguiente desafío. También puedes ver tu carga de entrenamiento general, que mide el volumen de ejercicio de los últimos 7 días y lo compara con el intervalo óptimo para tu condición física y tu historial de entrenamiento reciente.',
            'Más formas de entrenar',
            'Si lo que te gusta es correr, entrena de forma más inteligente con las herramientas disponibles en nuestra comunidad virtual de deporte Garmin Connect . Crea tus propios entrenamientos personalizados o descarga entrenamientos gratuitos para sincronizarlos directamente con el reloj. O, si tienes un objetivo específico en mente para tu próximo 5K, prueba el Garmin Coach. Con la orientación de expertos entrenadores y planes de entrenamiento gratuitos que se adaptan a ti y a tus metas, resulta un método infalible para llegar a la línea de meta. Como parte del plan de entrenamiento, puede incluso ayudarte a predecir tu tiempo de carrera. ¿Qué ocurre cuando quieras un cambio? Forerunner 245 también cuenta con perfiles de actividad para ciclismo, natación en piscina, ejercicios con ergómetro e incluso para entrenar con elíptica o escaladora.',
            'Analiza tu técnica de carrera',
            'El reloj con GPS Forerunner 245 además ofrece las herramientas que necesitas para mejorar tu técnica de carrera. Mide métricas de carrera importantes como la cadencia, la longitud de zancada, el equilibrio y el tiempo de contacto con el suelo, la oscilación vertical y el ratio vertical. Estas medidas son la clave para comprender tu técnica, por lo que podrás dar lo mejor de ti en cada carrera y en cada competición. El Forerunner 245 puede iniciar el seguimiento de estas métricas si añades una correa de frecuencia cardiaca compatible o el compacto Running Dynamics Pod, que se engancha cómodamente en la pretina del pantalón.',
            'Más opciones de personalización',
            'Echa un vistazo a nuestra Tienda Connect IQ , donde podrás dar un toque de personalidad al Forerunner 245 descargando aplicaciones, widgets, pantallas para el reloj y mucho más. Es fácil y, lo mejor de todo, gratuito. Cada día se añaden nuevas aplicaciones, que te permitirán saber cuándo llega tu Uber , ponerte un desafío con la aplicación Strava Relative Effort e incluso usar AccuWeather MinuteCast para estar al tanto de cuándo empezará a llover.',
            'Sigue conectado mientras corres',
            'Forerunner 245 te permite correr sin dejar de lado funciones inteligentes importantes. Cuando lo hayas vinculado con tu smartphone compatible, podrás recibir mensajes de texto, así como ver las novedades en tus redes sociales o los mensajes de correo electrónico, entre otras posibilidades, directamente en tu muñeca. Las nuevas funciones de seguimiento y seguridad facilitarán que compartas tu ubicación con los contactos que elijas en caso de que necesites ayuda, de forma manual o automática, con la tecnología de detección de incidencias integrada, si es necesario. Así que ponte las zapatillas y sal a hacer deporte con un poco más de tranquilidad.',
            'Comparte y compite',
    ...
    },
    {
        ...
        name: "Forerruner 45",
        price: 31858,
        image: 'images/indumentaria/relojes/garmin-forerunner-45-300x300.jpg',
        imagelg: 'images/indumentaria/relojes/garmin-forerunner-45.jpg',
        description: '',
        list: [
            'Reloj de carrera con GPS que admite planes de entrenamiento de Garmin Coach</p>',
            'Reloj de carrera fácil de usar que monitoriza la frecuencia cardiaca en la muñeca1 y utiliza el GPS para seguir tu ritmo, la distancia, los intervalos y mucho más',
            'Funciona con los planes de entrenamiento adaptables gratuitos de Garmin Coach que pone un entrenador personal experto en tu muñeca',
            'Cuenta con funciones de conexión2 como las notificaciones inteligentes para los mensajes de texto y llamadas que recibas, cargas automáticas a nuestra comunidad Garmin Connect™, seguimiento en directo y controles para la música de tu teléfono',
            'Las funciones de seguimiento y seguridad incluyen detección de incidentes (durante actividades concretas) y asistencia. Ambas funciones envían tu ubicación en tiempo real a tus contactos de emergencia',
            'Aplicaciones de deporte para carrera, ciclismo, carrera en pista en interiores, carrera en cinta, elíptica, cardio y yoga, entre otros',
            'Autonomía de la batería: hasta 7 días en modo smartwatch; 13 horas en modo GPS',
            'Antes de ponerte las zapatillas y empezar a correr, asegúrate de que tienes la herramienta adecuada. Además de ser un reloj de running con GPS equipado con todas las funciones de carrera que necesitas, el Forerunner 45 también es un reloj inteligente ligero y elegante que querrás llevar tanto de día como de noche.',
            'Controla tu corazón mientras corres',
            'Este reloj de carrera fácil de usar es el compañero perfecto para las sesiones diarias de carrera y entrenamiento, así como también para aquel 10K para el que te han convencido. El GPS integrado controla por dónde corres y te proporciona estadísticas precisas, incluyendo la distancia, el ritmo y los intervalos. La interfaz de botones intuitiva te permite marcar las vueltas y pausar el temporizador fácilmente incluso con las manos sudadas. El Forerunner 45 también monitoriza la frecuencia cardiaca en la muñeca, tanto por el día como por la noche1.',
            'Equípate con Garmin Coach',
            'Un poco de ayuda nunca viene mal, tanto para los corredores curtidos en mil batallas como para los recién iniciados. Es por eso por lo que el Forerunner 45 es compatible con los planes de entrenamiento adaptables de Garmin Coach. Estos planes ofrecen orientación de entrenadores expertos y planes de entrenamiento gratuitos que se adaptan a ti y a tus objetivos. Resulta un método infalible para llegar a la línea de meta. Como parte del plan de entrenamiento, incluso puede ayudarte a predecir tu tiempo de carrera, y las sesiones de entrenamiento se sincronizan directamente con tu reloj.'
        ],
        stock: 2,
        section: 'indumentaria', 
    },
    {
        ...
        name: "RC MTB",
        price: 51810,
        image: 'images/indumentaria/zapatillas/scott-rc-mtb-300x300.jpg',
        imagelg: 'images/indumentaria/zapatillas/scott-rc-mtb.jpg',
        description: '',
        list: [
    ...
    },
    {
        ...
        name: "Comp Boa",
        price: 23633,
        image: 'images/indumentaria/zapatillas/scott-boa-300x300.jpg',
        imagelg: 'images/indumentaria/zapatillas/scott-boa.jpg',
        description: 'Son la demostración perfecta de que un ajuste perfecto y unas altas prestaciones no tienen por qué tener un precio prohibitivo; las MTB Comp BOA® de SCOTT son perfectas para los que entienden de ciclismo y piensan primero en el presupuesto. El diseño del empeine con ajuste adaptativo incluye un sistema de ajuste BOA® L6. Combina todo esto con una correa de ajuste anatómico que la hace articulada y verás cómo se adapta a la forma de tu pie. La suela en inyección de compuesto con índice de rigidez 6, mayor rango de ajuste de los tacos y un toque mínimo de caucho de competición Sticki ofrece una tracción fantástica sobre raíces, piedras y tierra suelta.',
        list: [
            'Índice de rigidez 6',
            'Nylon/Suela exterior de compuesto',
            'Sistema BOA® y correa de ajuste anatómico',
            'Goma Sticki'
        ],
        stock: 2,
        section: 'indumentaria', 
    },
    {
        ...
        name: "Comp Boa Ruta",
        price: 22461,
        image: 'images/indumentaria/zapatillas/zapa-ruta-boa-300x300.jpg',
        imagelg: 'images/indumentaria/zapatillas/zapa-ruta-boa.jpg',
        description: 'Son la demostración perfecta de que un ajuste perfecto y unas altas prestaciones no tienen por qué tener un precio prohibitivo; las Road Comp Boa® de SCOTT son perfectas para los que entienden de ciclismo y piensan primero en el presupuesto. El diseño del empeine con ajuste adaptativo incluye un sistema de cierre Boa® L6. Combina todo esto con una correa de ajuste anatómico que la hace articulada y verás cómo se adapta a la forma de tu pie. La plantilla ErgoLogic incluye un soporte en el arco del pie y un botón metatarsiano. Tienen la suficiente rigidez que te pide tu instinto de competición, pero también son cómodas para pasar largas horas al pedal. La suela de nailon inyectado y fibra de vidrio permite un mayor rango de ajuste de los tacos y presenta un índice de rigidez de 6.',
        list: [
            'TIPO DE USO: Carreter',
            'COMPOSICIÓN: Suela externa: Compuesto, goma Sticki/ índice de rigidez 6',
            'EMPEINE: Poliuretano sintético, malla transpirable de nylon en 3D',
            'CIERRE: Sistema de cierre con BOA L6 y correa de ajuste anatómico',
            'PLANTILLA: Plantilla extraíble ErgoLogic'
        ],
        stock: 2,
        section: 'indumentaria', 
    },
    {
        ...
        name: "MTB Comp",
        price: 19551,
        image: 'images/indumentaria/zapatillas/scott-comp-mtb-300x300.jpg',
        imagelg: 'images/indumentaria/zapatillas/scott-comp.jpg',
        description: 'Las zapatillas MTB Comp RS de SCOTT son la prueba evidente de que no siempre hay que vaciar la cartera para disfrutar de un buen ajuste y altas prestaciones. El diseño adaptativo incluye paredes envolventes que se ajustan con una anilla semiesférica y una tira de velcro, así como dos tiras inferiores de montaje directo y ajuste anatómico articuladas para adaptarse a la forma del pie. Las zapatillas incluyen un empeine de piel sintética con malla 3D y lengüeta de microfibra con EVA formada en 3D. La suela en compuesto con índice de rigidez 6, mayor rango de ajuste de los tacos y un toque mínimo de caucho de competición Sticki ofrece una tracción fantástica sobre raíces, piedras y tierra suelta.',
        list: [
            'TIPO DE USO: Mtb',
            'COMPOSICIÓN: Suela externa: Compuesto, goma Sticki/ índice de rigidez 6',
            'EMPEINE: Poliuretano sintético, malla transpirable de nylon en 3D',
            'CIERRE: Sistema de cierre con correas de ajuste anatómico',
            'PLANTILLA: Plantilla extraíble ErgoLogic'
        ],
        stock: 2,
        section: 'indumentaria', 
